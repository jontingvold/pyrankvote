...
class TestElectionManager(unittest.TestCase):
    ...
    def test_simple(self):
        ...
        np.testing.assert_almost_equal(candidate_votes, correct_candidate_votes, 0.001, "Votes not counted correctly.")
    ...
    def test_candidates_have_most_second_votes(self):
        ...
        self.assertEqual(is_hard_ranked_first, True, "Hard, should rank before extra, because hard has more 2nd alternative votes")
    ...
    def test_elect_candidate(self):
        ...
        self.assertListEqual([stay_vc, soft_vc], manager._elected_candidates, "Stay should be before soft first since it is was elected first.")
    ...
    def test_reject_candidate(self):
        ...
        self.assertListEqual([stay_vc, soft_vc], manager._rejected_candidates, "Stay should be before soft first since it is was rejected first.")
        self.assertListEqual([hard_vc], manager._candidates_in_race)
        self.assertNotIn(stay_vc, manager._candidates_in_race)
